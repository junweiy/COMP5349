...
public class InputMapFunction implements MapFunction<Tuple2<String, String>, ItemSet> {
	 ...
	 */
	@Override
	public ItemSet map(Tuple2<String, String> arg0) throws Exception {
		return new ItemSet(Integer.parseInt(arg0.f1));
	}
